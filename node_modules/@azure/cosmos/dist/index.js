(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os-name'), require('tslib'), require('crypto'), require('debug'), require('priorityqueuejs'), require('semaphore'), require('fast-json-stable-stringify'), require('uuid'), require('jsbi'), require('node-abort-controller'), require('node-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os-name', 'tslib', 'crypto', 'debug', 'priorityqueuejs', 'semaphore', 'fast-json-stable-stringify', 'uuid', 'jsbi', 'node-abort-controller', 'node-fetch'], factory) :
    (global = global || self, factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}), global.osName, global.tslib_1, global.crypto, global.debugLib, global.PriorityQueue, global.semaphore, global.stableStringify, global.uuid, global.JSBI, global.AbortController, global.fetch));
}(this, (function (exports, osName, tslib, crypto, debugLib, PriorityQueue, semaphore, stableStringify, uuid, JSBI, AbortController, fetch) { 'use strict';
    ...
    function addPKToOperation(operation, definition) {
